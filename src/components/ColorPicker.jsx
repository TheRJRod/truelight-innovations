    ...
    >
      <div className="text-center mb-16">
        ...
        <p className="text-on-surface-variant max-w-2xl mx-auto text-lg">
          Customize your home's lighting for any occasion. From subtle elegance
          to bold celebrations, your imagination is the only limit.
        </p>
      </div>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="relative">
          ...
          >
            <path
              d="M50 150 L200 50 L350 150 L350 280 L50 280 Z"
              fill="#1c2026"
              stroke="#404753"
              strokeWidth="2"
            />
            <path
              d="M40 150 L200 40 L360 150 L350 150 L200 50 L50 150 Z"
              fill="#262a31"
              stroke="#404753"
              strokeWidth="2"
            />
        ...
        <div>
          ...
          <div className="bg-surface-container-low p-6 rounded-xl border border-outline-variant/10">
            <p className="text-sm text-on-surface-variant mb-4">
              ...
              Preset patterns for holidays, sports teams, special events, or
